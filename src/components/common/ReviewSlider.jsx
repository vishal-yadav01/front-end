...
// Get API function and the endpoint
  ...
  return (
    <div className="text-white">
      <div className="my-[50px] h-[184px] max-w-maxContentTab lg:max-w-maxContent">
        <Swiper
          slidesPerView={4} // Default for large displays
          spaceBetween={25}
          loop={true}
          freeMode={true}
          autoplay={{
          ...
          breakpoints={{
            320: {
              slidesPerView: 1, // Single slide for very small screens
              spaceBetween: 10,
            },
            480: {
            ...
            768: {
              slidesPerView: 3, // Three slides for tablets
              spaceBetween: 20,
            },
          }}
